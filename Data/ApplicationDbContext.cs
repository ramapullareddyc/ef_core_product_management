...
namespace EFCore.Data
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configure column mappings for Products
            ...
            modelBuilder.Entity<Product>().Property(e => e.IsDiscontinued).HasColumnName("isdiscontinued").HasConversion<int>();
            ...
            // Configure column mappings for Categories
            ...
            // Configure column mappings for Suppliers
            ...
            modelBuilder.Entity<Supplier>().Property(e => e.IsActive).HasColumnName("isactive").HasConversion<int>();
